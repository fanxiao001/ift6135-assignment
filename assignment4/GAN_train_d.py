...
# @last-modified Wed Apr 18 2018 09:55:08 GMT-0400 (EDT)
...
train_hist = GAN_CelebA.train3(G,D,G_optimizer,D_optimizer,train_data_loader,\
        BCE_loss,train_epoch,hidden_dim,critic_max=critic_max,savepath='GANDeconv_t8000_h100')
GAN_CelebA.saveCheckpoint(G,D,train_hist,'GANDeconvolution_t8000_h100_ep50.train3',use_cuda)
